...
**Scope**: Onboarding + Home + Generate ritual flow

**Included Screens**:
1. Welcome (Onboarding)
2. Initial Goal Setup (Onboarding)
3. Home Screen
   - Goal Box (editable)
   - Quick Starts carousel (6 pre-made rituals)
   - Generate button with configuration
   - Generation progress with background execution
   - Clarifying questions modal

**Included Features**:
- Complete onboarding flow
- Goal creation and editing
- Ritual generation (mocked AI with realistic delays)
- Background task execution
- Browser notifications
- Data persistence (localStorage)
- Bottom navigation (other tabs show placeholders)
- PWA setup (installable, offline-capable)

**Not Included Yet**:
- Ritual Library screen (shows placeholder)
- Ritual Editor (future)
- Session Player (future - quick starts won't play yet)
- Reflection screen (future)
- Dashboard screen (future)
- Profile/Settings screen (future)

### Phase 2: Ritual Library & Editor
- Browse saved rituals
- Ritual preview screen
- Full ritual editor (Structure, Prompt, Voice & Pacing, Advanced tabs)
- Duplicate/delete rituals
- Search and filters

### Phase 3: Session Player & Reflection
- Fullscreen session screen (sacred mode)
- Session playback with timing
- Audio context and soundscapes
- Reflection capture after session
- Session history

### Phase 4: Dashboard & Insights
- Stats and trends
- Calendar heatmap
- Insights feed (mocked initially)
...
- Real AI integration (Claude API or similar)
- Cloud sync with local-first architecture
